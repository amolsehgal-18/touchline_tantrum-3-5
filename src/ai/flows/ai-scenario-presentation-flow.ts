...
const FALLBACK_POOL: AiScenarioPresentationOutput[] = [
  {
    ...
    impactLeft: { board: 5, fans: 15, squad: -15 },
    impactRight: { board: -5, fans: -12, squad: 10 },
  ...
  },
  {
    ...
    impactLeft: { board: -15, fans: 12, squad: 5 },
    impactRight: { board: 10, fans: -8, squad: -2 },
  ...
  },
  {
    ...
    impactLeft: { board: 0, fans: -5, squad: -10 },
    impactRight: { board: -5, fans: 5, squad: 5 },
  ...
  },
  {
    ...
    impactLeft: { board: -10, fans: -20, squad: 10 },
    impactRight: { board: 5, fans: 15, squad: -5 },
    imageCategory: "fans",
    isBreaking: true,
  ...
  },
  {
    ...
    impactLeft: { board: 10, fans: 5, squad: -15 },
    impactRight: { board: -5, fans: -5, squad: 12 },
  ...
  },
  {
    ...
    impactLeft: { board: 15, fans: -10, squad: -8 },
    impactRight: { board: -12, fans: 8, squad: 10 },
    imageCategory: "finance",
    isBreaking: false,
  ...
  },
  {
    ...
    impactLeft: { board: -5, fans: -8, squad: -12 },
    impactRight: { board: 5, fans: 5, squad: 15 },
    imageCategory: "training_ground",
    isBreaking: false,
  ...
  },
  {
    ...
    impactLeft: { board: -15, fans: -10, squad: 0 },
    impactRight: { board: 5, fans: 12, squad: -5 },
  ...
  },
  {
    ...
    impactLeft: { board: 5, fans: 15, squad: -5 },
    impactRight: { board: 0, fans: -12, squad: 5 },
    imageCategory: "fans",
    isBreaking: false,
  ...
  },
  {
    ...
    impactLeft: { board: 0, fans: 10, squad: 8 },
    impactRight: { board: 5, fans: -5, squad: -2 },
    imageCategory: "press",
    isBreaking: false,
