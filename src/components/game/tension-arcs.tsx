  ...
  return (
    <div className="relative flex flex-col items-center" style={{ width: size }}>
      <svg width={size} height={size / 2 + 10} className="overflow-visible">
        {drawArc(board, 75, "#3b82f6", "board")}
        {drawArc(fans, 58, "#f97316", "fans")}
        {drawArc(morale, 41, "#22c55e", "morale")}
      </svg>
      
      <div className="grid grid-cols-3 gap-2 text-[7px] font-headline uppercase tracking-widest opacity-60 mt-4 w-full">
